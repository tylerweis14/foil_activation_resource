...
\begin{figure}[!ht]
   \centering
   \subfloat[][Position \#1]{\includegraphics[width=.4\textwidth]{plot/rh1_activity}}\quad
   \subfloat[][ ($n,\gamma$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/rh_n,gamma}}\\ 
   \subfloat[][ ($n,n'$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/rh_n,inelastic}}\quad 

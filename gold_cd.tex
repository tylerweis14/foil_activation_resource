...
\begin{figure}[!ht]
   \centering
   \subfloat[][Position \#1]{\includegraphics[width=.4\textwidth]{plot/au1cd_activity}}\quad
   \subfloat[][ ($n,\gamma$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/au_n,gamma_cd}}\\ 
   \subfloat[][ ($n,2n$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/au_n,2n_cd}}\quad 
   \subfloat[][ ($n,n'$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/au_n,inelastic_cd}}\\ 

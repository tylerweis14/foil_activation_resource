...
Mg['reactions']['n,p']['roi'] = 6.4269e+06,1e+07  # initial guess
...
Sc['reactions']['n,gamma']['roi'] = 6.6594e-03, 2.7942e-01 # initial guess
...
Ti['reactions']['n,p']['func'] = f
Ti['reactions']['n,p']['region'] = r
Ti['reactions']['n,p']['roi'] = 4.6369e+06, 1e+07 # initial guess
...
Mn['reactions']['n,gamma']['roi'] = 1e-03, 1e-01 # computed
...
Fe['reactions']['n,p']['roi'] = 1e+06,1e+07 # initial guess
...
Fe['reactions']['n,gamma']['roi'] = 2.9877e-04, 3.5809 # initial guess
...
Ni['reactions']['n,p']['roi'] = 1.9380e+06, 1e+07 # initial guess
...
Cu['reactions']['n,gamma']['roi'] = 10e-3, 5.7752e-1 # initial guess
...
Zn['reactions']['n,p']['roi'] = 1e+05, 1e+06 # initial guess
...
Zr['reactions']['n,2n']['roi'] = 1.2300e+06, 1.5072e+07 # initial guess
...
Eu['reactions']['n,gamma']['roi'] = 1e-03,1e-01 # initial guess
...
Dy['reactions']['n,gamma']['roi'] = 6.3127e-03, 1e-01  # initial guess
...
Lu['reactions']['n,gamma']['roi'] = 5e-03,1e-01 # initial guess
...
Ir['reactions']['n,gamma']['roi'] = 1e-03,1e-01 # initial guess

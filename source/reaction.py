...
foils['MoCd'] = Reaction('Mo-98', 'n,gamma', 'Mo-99', True, 95.95, 10.28, '42-Mo-98(n,&gamma;).txt', 66*3600, 0.2429, 740, 0.12, -1)
...
foils['CuCd'] = Reaction('Cu-63', 'n,gamma', 'Cu-64', True, 63.546, 8.96, '29-Cu-63(n,&gamma;).txt', 61.9*3600, 0.6915, 1345.77, 0.00475, -1)
foils['Mg'] = Reaction('Mg-24', 'n,p', 'Na-24', False, 24.305, 1.738, '12-Mg-24(n,p).txt', 15.03*3600, 0.79, 1368.626, 0.999936, -1)
...
foils['CaCd'] = Reaction('Ca-44', 'n,gamma', 'Ca-45', True, 40.078, 1.55, '20-Ca-44(n,&gamma;).txt', 165*24*3600, .02086, 12.47, 3e-8, -1)
foils['Sc'] = Reaction('Sc-45', 'n,gamma', 'Sc-46', False, 44.955910, 2.985, '21-Sc-45(n,&gamma;).txt', 84*24*3600, 1.0, 1120.545, 0.99987, -1)
foils['ScCd'] = Reaction('Sc-45', 'n,gamma', 'Sc-46', True, 44.955910, 2.985, '21-Sc-45(n,&gamma;).txt', 84*24*3600, 1.0, 1120.545, 0.99987, -1)
foils['Mn'] = Reaction('Mn-55', 'n,gamma', 'Mn-56', False, 54.938044, 7.21, '25-Mn-55(n,&gamma;).txt', 2.58*3600, 1.0, 1810.726, 0.269, -1)
foils['MnCd'] = Reaction('Mn-55', 'n,gamma', 'Mn-56', True, 54.938044, 7.21, '25-Mn-55(n,&gamma;).txt', 2.58*3600, 1.0, 1810.726, 0.269, -1)
...
foils['DyCd'] = Reaction('Dy-164', 'n,gamma', 'Dy-165', True, 162.5, 8.54, '66-Dy-164(n,&gamma;).txt', 2.35*3600, 0.2826, 108.160, 0.0301, -1)

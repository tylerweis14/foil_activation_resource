...
\begin{figure}[!ht]
   \centering
   \subfloat[][Position \#1]{\includegraphics[width=.4\textwidth]{plot/in1cd_activity}}\quad
   \subfloat[][ ($n,\gamma$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/in_n,gamma_cd}}\\ 
   \subfloat[][ ($n,n'$) Reaction Rate]{\includegraphics[width=.4\textwidth]{plot/in_n,inelastic_cd}}\quad 
